...
// Returns the private 'App\Repository\FormeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FormeRepository.php';

return $this->privates['App\\Repository\\FormeRepository'] = new \App\Repository\FormeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
