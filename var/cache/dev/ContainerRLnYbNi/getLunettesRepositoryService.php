...
// Returns the private 'App\Repository\LunettesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\LunettesRepository.php';

return $this->privates['App\\Repository\\LunettesRepository'] = new \App\Repository\LunettesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
