...
// Returns the private 'App\Repository\RegistrationTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RegistrationTypeRepository.php';

return $this->privates['App\\Repository\\RegistrationTypeRepository'] = new \App\Repository\RegistrationTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
